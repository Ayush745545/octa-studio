            ...
            <div className="flex items-end justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-zinc-400">
                  Schedule and manage each channel independently.
                </p>
              </div>
            ...
            {publications.length === 0 ? (
              ...
              <div className="mt-5 overflow-x-auto rounded-2xl border border-zinc-200">
                <div className="min-w-[900px]">
                  <div className="grid grid-cols-[minmax(0,1fr)_110px_110px_220px_160px] border-b border-zinc-200 bg-zinc-50 px-5 py-3 text-[11px] font-medium uppercase tracking-wider text-zinc-400">
                    <span>Content</span>
                    <span>Channel</span>
                    <span>Status</span>
                    <span>Schedule</span>
